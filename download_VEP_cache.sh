...
curl -O https://ftp.ensembl.org/pub/release-112/variation/indexed_vep_cache/homo_sapiens_vep_112_GRCh37.tar.gz
tar xzf homo_sapiens_vep_112_GRCh37.tar.gz
rm -f homo_sapiens_vep_112_GRCh37.tar.gz

curl -O https://ftp.ensembl.org/pub/release-112/fasta/homo_sapiens/dna/Homo_sapiens.GRCh38.dna.primary_assembly.fa.gz
